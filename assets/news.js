...
window.LEAGUE_NEWS = [
  ...
  },
  {
    ...
    "caption": "",
    "body": [
      "Con unos odds de 51/49, Los Puntos de Pina vs Sierra Linda Cameltoes prometen un banger esta semana. Dos equipos que llegan 0-1 y necesitan desesperadamente su primera victoria, así que esto va a estar peleado hasta el final.",
      "Cómo llegan los dos equipos",
      "Los Puntos de Pina cayeron en la semana 1 contra Mugiwaras De Caimito y ahora están de cuartos en la tabla. Sierra Linda tampoco arrancó bien, perdieron contra Peter's Perfect Team. O sea que ninguno de los dos se puede dar el lujo de empezar 0-2. Esto es prácticamente una final anticipada para no quedarse atrás desde ya.",
      "Los Puntos de Pina - lo que traemos",
      "El ataque terrestre luce sólido con Bijan Robinson y Kyren Williams de titulares, más David Montgomery y Bucky Irving repartiéndose el flex. Ahí hay volumen de sobra.",
      "Por el aire, Brock Purdy tira desde QB y Caleb Williams entra por el slot de OP, así que estamos jugando dos quarterbacks esta semana, lo cual le mete un techo alto al equipo si ambos tienen un buen día.",
      "En receptores, Davante Adams, DJ Moore y Emeka Egbuka forman un trío que puede hacer daño, y Tyler Warren en TE sigue siendo una pieza confiable.",
      "Sierra Linda Cameltoes - el rival",
      "No hay que dormirse con este equipo. Lamar Jackson en QB y Justin Herbert en el slot de OP les da un techo altísimo en el aire, capaz el más peligroso de toda la liga en ese puesto.",
      "En el backfield tienen a De'Von Achane, que cuando explota es de temer, junto con Chase Brown y Travis Etienne Jr. de flex. Y en receptores traen a Jaxon Smith-Njigba, Drake London y DeVonta Smith, tres nombres que cualquiera respeta.",
      "Por qué va a estar cerrado",
